  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-muted/20 relative">
        {/* Top bar with user menu and tier badge - floating on top */}
        <div
          ref={topBarRef}
          className={`absolute top-0 left-0 right-0 flex items-center justify-between px-6 py-3 border-b border-border bg-background z-10 transition-transform duration-300 ease-in-out ${
